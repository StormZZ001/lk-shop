  ...
  <div class="wrapper">
      <div class="titleWrapper">
          <div class="left">
            ...
            <span class="status">07:00场</span>
            <div class="statusEnd">已结束</div>
          </div>
          <span class="more">更多</span>
      </div>
      <div class="itemWrapper">
          <ul class="flash_list">
              <li class="flash_item" v-for="product in flashsale_list" :key="product.id">
                  <a href="#" class="flash_link">
                      <div class="img">
                          <img :src="product.small_image" alt="" class="flash_image">
                      </div>
                      <p class="flash_name">{{product.name}}</p>
                      <p class="flash_origPrice"><del>&yen;{{product.origin_price}}</del></p>
                      <div class="flash_bottom">
                          <p class="flash_price">&yen;{{product.price}}</p>
